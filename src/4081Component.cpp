...
void nts::Component4081::simulate(__attribute__((unused)) std::size_t thick)
{
    nts::Tristate in1 = this->compute(1);
    nts::Tristate in2 = this->compute(2);
    nts::Tristate result = nts::AndComponent::andOp(in1, in2);
    ...
    in1 = this->compute(5);
    in2 = this->compute(6);
    result = nts::AndComponent::andOp(in1, in2);
